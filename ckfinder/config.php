 ...
 */
$userUpload = $_SESSION['login']['username'];
//$baseUrl = 'http://localhost/tvsc/img/upload/' . $userUpload . '/'; version cu~
$baseUrl = $_SESSION['login']['upload'] . $userUpload . '/';
